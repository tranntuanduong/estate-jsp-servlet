...
<%@ page import = "com.laptrinhjavaweb.utils.DataUtils" %>
...
<body>
										...
										<tbody>
											<tr>
												<td><input type="checkbox" value="${item.id}"
													${item.customerChecked} name="staffId"></td>
												<td>${item.fullName}</td>
											</tr>
										</tbody>		  
										    &nbsp; &nbsp; &nbsp; 
	...
	<script type="text/javascript">
			...
			$
					.ajax({
						...
						success : function(data) {
							window.location.href = "${customerURL}?action=EDIT&customerId="
									+ id
									+ "&role=staff&message=addCustomerSuccess";
						},
						error : function() {
		...
		$('IDIDIDIDIID ?????? ').on('click', function(event) {
			event.stopPropagation();
			event.stopImmediatePropagation();
			ar customerId = $('#customerId').val();
